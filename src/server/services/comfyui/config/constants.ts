...
export const FLUX_MODEL_CONFIG = {
  FILENAME_PREFIXES: {
    DEV: 'Qingzhou/%year%-%month%-%day%/FLUX_Dev',
    KONTEXT: 'Qingzhou/%year%-%month%-%day%/FLUX_Kontext',
    KREA: 'Qingzhou/%year%-%month%-%day%/FLUX_Krea',
    SCHNELL: 'Qingzhou/%year%-%month%-%day%/FLUX_Schnell',
  },
} as const;
...
export const SD_MODEL_CONFIG = {
  FILENAME_PREFIXES: {
    CUSTOM: 'Qingzhou/%year%-%month%-%day%/CustomSD',
    SD15: 'Qingzhou/%year%-%month%-%day%/SD15',
    SD35: 'Qingzhou/%year%-%month%-%day%/SD35',
    SDXL: 'Qingzhou/%year%-%month%-%day%/SDXL',
  },
} as const;
