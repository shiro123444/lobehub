export default {
  ...
  'betterAuth.errors.emailRequired': 'Please enter your student ID or email',
  ...
  'betterAuth.errors.usernameExists': 'This student ID or username is already registered',
  'betterAuth.errors.usernameInvalid': 'Use letters, numbers, underscores, or dots only',
  'betterAuth.errors.usernameMaxLength': 'Username must not exceed 32 characters',
  'betterAuth.errors.usernameMinLength': 'Username must be at least 2 characters',
  ...
  'betterAuth.signin.emailPlaceholder': 'Enter student ID or email',
  ...
  'betterAuth.signin.qqLoginButton': 'QQ group verification',
  'betterAuth.signin.qqLoginClose': 'Close',
  'betterAuth.signin.qqLoginCodeLabel': 'Verification code',
  'betterAuth.signin.qqLoginDescription':
    'Send this 6-digit code in the configured QQ group. The bot will confirm your identity automatically.',
  'betterAuth.signin.qqLoginError': 'Failed to start QQ group verification',
  'betterAuth.signin.qqLoginExpired': 'This code has expired. Close and try again.',
  'betterAuth.signin.qqLoginPending': 'Waiting for bot confirmation...',
  'betterAuth.signin.qqLoginPreview': 'Local database is offline. This is a UI preview only.',
  'betterAuth.signin.qqLoginRefresh': 'New code',
  'betterAuth.signin.qqLoginSuccess': 'Verified. Signing you in...',
  'betterAuth.signin.qqLoginTitle': 'QQ Group Login',
  ...
  'betterAuth.signup.usernamePlaceholder': 'Student ID or username',
