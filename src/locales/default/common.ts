export default {
  'presentationStoryboard.pages': '{{count}} pages',
  'presentationStoryboard.view': 'Switch card layout',
  'presentationStoryboard.create': 'Start creating',
  'presentationStoryboard.claim': 'Core message',
  'presentationStoryboard.points': 'Key points',
  'presentationStoryboard.visual': 'Visual direction',
  'presentationStoryboard.notes': 'Speaker notes',

  'presentationTemplates.nativeClose': 'Close native editing',
  'presentationTemplates.nativePrompt': 'Native editing instructions',
  'presentationTemplates.nativePlaceholder': 'What would you like to change in this original?',
  'presentationTemplates.nativeRun': 'Apply native edits',
  'presentationTemplates.nativeDownload': 'Download PPTX',
  'presentationTemplates.nativeDone': 'Edits completed with native structure preserved',
  'presentationTemplates.nativeUnavailable': 'No downloadable file was produced',
  'presentationTemplates.nativeModify': 'Edit original PPTX',
  'presentationTemplates.nativeModifyNamed': 'Edit original {{name}}',
  'presentationTemplates.history': 'My presentations',

  'presentationTemplates.newPresentation': 'New presentation',
  'presentationTemplates.select': 'Use {{name}}',
  'presentationTemplates.clear': 'No template',
  'presentationTemplates.title': 'Templates',
  'presentationTemplates.name': 'Template name',
  'presentationTemplates.learn': 'Learn from this presentation',
  'presentationTemplates.import': 'Import a reference PPTX',
  'presentationTemplates.empty': 'No saved templates yet',
  'presentationTemplates.apply': 'Apply {{name}}',
  'presentationTemplates.applied': 'Applying {{name}}',
  'presentationTemplates.saved': 'Saved {{name}}',
  'presentationTemplates.untitled': 'My template',
  'presentationTemplates.waitForCompletion': 'Save a template once generation finishes',
  'presentationTemplates.error': 'Template request failed. Please try again.',
  'presentationTemplates.invalidFile': 'Choose a PPTX file up to 32 MB.',
  'presentationConversation.open': 'Chat',
  'presentationConversation.collapse': 'Minimize chat',
  'presentationConversation.quickCreate': 'Create directly',
  'presentationConversation.backToPlanning': 'Back to conversation',
  'presentationConversation.title': 'Chat with your presentation',
  'presentationConversation.hint':
    'Keep chatting while it works. Instructions are applied in order; other pages are preserved.',
  'presentationConversation.placeholder': 'What would you like to change?',
  'presentationConversation.send': 'Send changes',
  'presentationConversation.deck': 'Entire presentation',
  'presentationConversation.page': 'Page {{number}}',
  'presentationConversation.target': 'Change scope',
  'presentationConversation.queued': 'Received · queued',
  'presentationConversation.applying': 'Updating pages…',
  'presentationConversation.applied': 'Updated · ready to preview and export',
  'presentationConversation.failed': 'Update failed · retry to continue',
  'presentationConversation.cancel': 'Stop generation',
  'presentationConversation.retry': 'Continue generation',
  'presentationConversation.version': '{{count}} saved versions',
  'presentationConversation.empty': 'Your instructions and their results will appear here.',
  'about': 'About',
  ...
  'agentOnboardingPromo.description':
    'Set up your agent teams in a quick chat with jumi AI. Your existing agents remain unchanged.',
  ...
  'messengerBanner.title': 'Talk to jumi AI on your favorite messaging apps',
  'branching': 'Create Subtopic',
  'branchingDisable':
    'The "Sub-topic" feature is unavailable in the current mode. To use this feature, please switch to Postgres/Pglite DB mode or use Qingzhou Cloud.',
