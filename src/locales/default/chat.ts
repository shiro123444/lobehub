export default {
  ...
  'claudeCodeInstallGuide.reason': 'Qingzhou could not start Claude Code: {{message}}',
  ...
  'codexInstallGuide.reason': 'Qingzhou could not start Codex: {{message}}',
  ...
  'plus.search.appSearchDesc':
    'Qingzhou optimized search service, delivering best retrieval results.',
  ...
  'sharePageDisclaimer':
    'This content is shared by a user and does not represent the views of Qingzhou. Qingzhou is not responsible for any consequences arising from this shared content.',
  ...
  'taskList.unassignedHint': 'jumi AI will run this task when no assignee is set',
