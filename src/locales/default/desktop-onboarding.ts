export default {
  ...
  'screen4.share.description':
    'Share anonymized usage data to help us improve Nexus. This helps us understand how Agents are used and make them better.',
  ...
  'screen4.share.title': 'Help Improve Nexus',
  ...
  'screen5.actions.signInCloud': 'Sign in to Nexus Cloud',
  ...
  'screen5.methods.cloud.description':
    'Sign in with your Nexus Cloud account to sync everything seamlessly',
  'screen5.methods.cloud.name': 'Nexus Cloud',
  'screen5.methods.selfhost.description': 'Connect to your own Nexus server instance',
