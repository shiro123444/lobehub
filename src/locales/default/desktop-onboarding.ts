export default {
  ...
  'screen4.share.description':
    'Share anonymized usage data to help us improve Qingzhou. This helps us understand how Agents are used and make them better.',
  ...
  'screen4.share.title': 'Help Improve Qingzhou',
  ...
  'screen5.actions.signInCloud': 'Sign in to Qingzhou Cloud',
  ...
  'screen5.methods.cloud.description':
    'Sign in with your Qingzhou Cloud account to sync everything seamlessly',
  'screen5.methods.cloud.name': 'Qingzhou Cloud',
  'screen5.methods.selfhost.description': 'Connect to your own Qingzhou server instance',
