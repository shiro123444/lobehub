export default {
  ...
  'remoteServer.configDesc': 'Connect to the remote Qingzhou server to enable data synchronization',
  ...
  'sync.lobehubCloud.title': 'Qingzhou Cloud',
