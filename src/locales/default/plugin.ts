export default {
  ...
  'protocolInstall.official.badge': 'Qingzhou Official Skill',
  'protocolInstall.official.description': 'Official Qingzhou Skill, verified and security-checked.',
  ...
  'skillDetail.trustWarning':
    "Only use connectors from developers you trust. Qingzhou does not control which tools developers make available and cannot verify that they will work as intended or that they won't change.",
  'skillInstallBanner.dismiss': 'Dismiss',
  'skillInstallBanner.title': 'Connect your favorite apps to jumi AI',
  ...
  'store.tabs.mcp': 'MCP',
  'store.tabs.old': 'Qingzhou Skills',
