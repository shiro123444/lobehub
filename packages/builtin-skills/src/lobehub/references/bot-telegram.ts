...
- **Secret Token** (optional): a custom string you define; Qingzhou includes it in webhook requests so you can verify they genuinely come from Qingzhou — leave blank unless you have a security requirement
