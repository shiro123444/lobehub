export default {
  ...
  'share.budget.confirm.rules.source': 'Usage is tracked for this shared agent.',
  'share.budget.confirm.title': 'Update shared usage?',
  'share.budget.consumed': 'Usage',
  'share.budget.desc': 'Manage the usage allowance for this shared agent.',
  'share.budget.error.insufficient': 'There is not enough available usage',
  'share.budget.error.noSubscription': 'This action is currently unavailable',
  'share.budget.noSubscription': 'Usage allocation is currently unavailable.',
  'share.budget.privacyNotice': 'Visitor conversations use the allowance assigned to this agent',
  'share.budget.title': 'Shared Usage',
  'share.budget.transfer': 'Continue',
  'share.budget.transferError': 'Update failed, please try again later',
  ...
  'share.settings.limits.maxTopicsPerVisitorHint': 'Up to {{max}} conversations per visitor.',
  ...
  'share.settings.tools.notAvailableToVisitors':
    'This tool is not available to visitors for security reasons and cannot be enabled here.',
  'share.settings.tools.title': 'Tool Whitelist',
  'share.updateError': 'Failed to update share settings',
  'share.usage.desc': 'Usage generated by visitors chatting with this shared agent.',
  'share.usage.empty': 'No visitor usage yet.',
  'share.usage.logs.credits': 'Credits',
  'share.usage.logs.model': 'Model',
  'share.usage.logs.time': 'Time',
  'share.usage.title': 'Visitor Usage',
