...
CREATE INDEX IF NOT EXISTS "topics_project_id_idx" ON "topics" USING btree ("project_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "topics_project_working_directory_id_idx" ON "topics" USING btree ("project_working_directory_id");
